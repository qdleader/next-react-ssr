...
const Home = () => {
	...
	const listenScroll = () => {
		window.addEventListener("scroll", (e) => {
			...
			let $h1: HTMLElement = document.querySelector(".title-text") as HTMLElement
			let $theChip: HTMLElement = document.querySelector("#the-chip") as HTMLElement
			let $A13: HTMLElement = document.querySelector("#A13") as HTMLElement
			let $A13TextBg: HTMLElement = document.querySelector("#the-chip .text-bg") as HTMLElement
			...
			<div className="top-box">
				<section id="chip-section">
					<video
						...
						loop
					></video>
					<h1 className="top-box-title title-text">
						Hello?
						<br />
						Front-end
					</h1>
					<div id="the-chip">
						<svg
							...
							viewBox="0 0 256 228"
						>
							<rect className="text-bg" x="78" y="307" width="843" height="387"></rect>
							<path
								fill="#00D8FF"
